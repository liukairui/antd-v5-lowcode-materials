    ...
    "props": [
      ...
      },
      {
        "title": {
          ...
          "tip": "ranges | @deprecated Please use `presets` instead"
        },
        "name": "ranges",
        "description": "@deprecated Please use `presets` instead",
        "setter": {
          "componentName": "ObjectSetter",
          "props": {
            "config": {
      ...
      },
      {
        "title": {
          ...
          "tip": "activePickerIndex | @private Internal control of active picker. Do not use since it's private usage"
        },
